...
function App() {
  ...
  return (
<div className="min-h-screen flex items-center justify-center p-4 bg-gradient-to-br from-blue-100 via-white to-cyan-100">s
{!showChat ? (
...
<label className="text-sm font-semibold text-gray-600 flex items-center gap-2">
  <User className="w-4 h-5" /> Your Username
</label>
<input
  type="text"
